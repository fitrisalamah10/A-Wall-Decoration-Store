...
<form method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="ketdiskon" value="<?php echo $pecah['ket_diskon'];?>">
	</div>
...
if(isset($_POST['ubah']))
{
	...
	ket_satuan='$_POST[ketsatuan]', ket_diskon='$_POST[ketdiskon]' WHERE id_satuan='$_GET[id]'");

echo "<script> alert(' Data Berhasil Diubah');</script>";
echo "<script>location='index2.php?halaman=satuan2';</script>";
}
