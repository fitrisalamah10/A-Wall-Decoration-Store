...
<table class="table table-bordered"background="img.jpg">
	...
	<tbody>
		...
		<tr>
			...
			<td> 
				<a href="index.php?halaman=hapuspembeli&id=<?php echo $pecah['usernamee'];?> " class="btn-danger btn" >Hapus</a>
				<a href="index.php?halaman=ubahpembeli&id=<?php echo $pecah['usernamee'];?>" class="btn btn-warning"> Ubah </a>
			</td>
		</tr>
		<?php $nomor++; ?>
		<?php } ?>
