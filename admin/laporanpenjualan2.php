...
<table class="table table-bordered" background="img.jpg">
	...
	<tbody>
		...
		<tr>
			...
			<td> 
				<a href="index2.php?halaman=hapusfaktur2&id=<?php echo $value['id_faktur'];?>" class="btn-danger btn" >Hapus</a>
				<a href="index2.php?halaman=ubahfaktur2&id=<?php echo $value['id_faktur'];?>" class="btn btn-warning"> Ubah </a>
				<a href="index2.php?halaman=detail2&id=<?php echo $value['id_faktur']?>" class="btn btn-info" >Detail</a>
				
				<?php if($value['ket_statproses']=="Selesai"  ):?>
				<a href="index2.php?halaman=penilaian2&id=<?php echo $value['id_faktur']?>" class="btn btn-primary" >Penilaian</a>
				<?php endif?>
				
				<?php if($value['ket_statbayar']!=="Belum Dibayar"):?>
				<a href="index2.php?halaman=bayar2&id=<?php echo $value['id_faktur']?>
