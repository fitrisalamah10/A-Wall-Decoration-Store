...
$query=mysqli_query($koneksi, "SELECT * FROM customer WHERE nama_customer LIKE '%$keyword%' OR username LIKE '%$keyword%'")
?>
<div class="row">
    <div class="col-lg-12">
        <h2>DATA CUSTOMER</h2>   
...
<table class="table table-bordered"background="img.jpg">
	...
	<tbody>
		<?php $nomor=1;?>
		<?php $ambil=$koneksi->query("SELECT*FROM customer WHERE nama_customer LIKE '%$keyword%' OR username LIKE '%$keyword%'");?>
