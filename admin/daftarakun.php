...
<form role="form" action="prosesdaftar.php" method="post">
 <img src="images/login02_popup.png" alt="">
  ...
  <h3 data-edit="text">Silahkan Daftarkan Username dan Password yang Anda Inginkan</h3>
  <div class="ebook-email-sec">
    <input name="username" type="text" class="ebookemail-input1" data-edit="placeholder" placeholder="Enter User Name">
