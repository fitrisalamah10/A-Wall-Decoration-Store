...
$query=mysqli_query($koneksi, "SELECT * FROM barang WHERE nama_barang LIKE '%$keyword%' OR id_barang LIKE '%$keyword%'")
...
<table class="table table-bordered"background="img.jpg">
	...
	<tbody>
		...
		ukuran ON barang.id_ukuran=ukuran.id_ukuran WHERE nama_barang LIKE '%$keyword%' OR id_barang LIKE '%$keyword%'");?>
