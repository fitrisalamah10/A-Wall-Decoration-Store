...
<form role="form"  method="post">
 <img src="images/login02_popup.png" alt="">
  ...
  <div class="ebook-email-sec">
    <input autocomplete="off" name="usernamee" type="text" class="ebookemail-input1" data-edit="placeholder" placeholder="Enter User Name" >
...
if(isset($_POST["login"]))
{
	...
	$nama = $_POST["usernamee"];
	$pas = $_POST["pass"];
	
	//lakukan query ngecek akun di tabel pembeli di db
	$ambil=$koneksi->query("SELECT * FROM customer WHERE username='$nama' AND pass='$pas'");
