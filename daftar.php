...
<form role="form" action="cekdaftar.php" method="post">
 <img src="images/login02_popup.png" alt="">
  ...
  <h3 data-edit="text">Silahkan Masukkan Data Anda</h3>
  <div class="ebook-email-sec">
    <br>Username : <input autocomplete="off" name="username" type="text" class="form-control" placeholder="Masukkan Username"></br>
    <br> Password : <input name="pass" type="password" class="form-control" placeholder="Masukkan Password"></br>
	<br> Nama Lengkap :<input autocomplete="off" name="nama_customer" type="text" class="form-control" placeholder="Masukkan Nama Lengkap"> </br>
	<br> Alamat :<input autocomplete="off" name="alamat" type="text" class="form-control" placeholder="Masukkan Alamat"></br>
	<br> Kota :<input autocomplete="off" name="kota" type="text" class="form-control" placeholder="Masukkan kota"></br>
	
	<br> No HP :<input autocomplete="off" name="no_hp" type="text" class="form-control" placeholder="Masukkan Nomor Hp"></br>
<BR>
    <button class="ebook-input-btn" type="submit">Daftar</button>
</BR>
  </div>
